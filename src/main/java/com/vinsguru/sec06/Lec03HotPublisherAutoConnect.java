...
public class Lec03HotPublisherAutoConnect {
    ...
    public static void main(String[] args) {
        ...
        var miveFlux = movieStream()
                .publish().autoConnect(0); // this made hot publisher, different subscribers are sharing same streaming resources
        Util.sleepSeconds(2);
        miveFlux.take(4).subscribe(Util.subscriber("sam"));

        Util.sleepSeconds(3);

        miveFlux.take(3).subscribe(Util.subscriber("mike"));
